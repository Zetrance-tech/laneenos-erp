...
import { addMeal, getMealPlan, editMeal, deleteMeal, batchAddMeals } from "../controllers/mealController.js";
...
router.post("/batch-add", authMiddleware(["admin", "teacher"]), batchAddMeals);
