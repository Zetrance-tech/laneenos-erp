...
import FeesTypes from "../management/feescollection/feesConcession";
...
import ParentCCTVList from "../management/cctv/cctvList";
...
export const protectedPublicRoutes = [
  ...
  {
    path: routes.viewEnquiry,
    element: <AddEnquiry />,
  },
  {
    path: routes.editEnquiry,
    element: <AddEnquiry />,
  },
  {
