...
const StudentReport = () => {
  ...
  const exportToCSV = (data: Student[], filename: string) => {
    ...
    const rows = data.map((student) => [
      ...
      escapeCSVField(String(student.fatherInfo?.phoneNumber || '').trim()),
      ...
      escapeCSVField(String(student.motherInfo?.phoneNumber || '').trim()),
      ...
      escapeCSVField(String(student.guardianInfo?.phoneNumber || '').trim()),
  ...
  const handleExport = () => {
    const filename = selectedClass ? `students_${selectedClass}_report.csv` : "students_report.csv";
        ...
        <div className="content">
          ...
          <div className="card">
            <div className="card-header d-flex align-items-center justify-content-between flex-wrap pb-0">
              <h4 className="mb-3">Student Report</h4>
